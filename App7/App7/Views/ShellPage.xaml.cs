...
namespace App7.Views
{
    public sealed partial class ShellPage : Page, INotifyPropertyChanged
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<ImageGalleryPage>("Shell_ImageGallery".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<SystemInformationPage>("System Info", Symbol.Tag));
